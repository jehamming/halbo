...
public class MainGameLoop {
    ...
    public static void main(String[] args) {
     ...
     //   TexturedModel lamp = new TexturedModel(lampModel, new ModelTexture(loader.loadTexture("lamp")));
        ...
        FlatTerrain terrain = new FlatTerrain(0, -1, loader, texturePack, blendMap);
   ...
   /*     List<Entity> entities = new ArrayList<>();
        ...
        for (int i = 0; i < 400; i++) {
            if (i % 2 == 0) {
                ...
                float y = heightTerrain.getHeightOfTerrain(x, z);
      ...
      //  entities.add(new Entity(lamp, new Vector3f(370, 4.2f, -300),0,0,0,1));
       // entities.add(new Entity(lamp, new Vector3f(293, -6.8f, -305),0,0,0,1));
        ...
        Player player = new Player("DRGN", dragon, new Vector3f(100, 0, -50), 0, 0, 0, 0.5f);
