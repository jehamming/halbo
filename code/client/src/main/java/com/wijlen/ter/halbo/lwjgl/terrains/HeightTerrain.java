...
public class HeightTerrain implements Terrain {
    ...
    public HeightTerrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap) {
