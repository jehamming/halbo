package com.hamming.halbo.client.engine.toolbox;
...
public class Maths {
	...
	public static Matrix4f createTransformationMatrix(Vector3f translation, float pitch, float yaw, float scale) {
		Matrix4f matrix = new Matrix4f();
		matrix.setIdentity();
		Matrix4f.translate(translation, matrix, matrix);
