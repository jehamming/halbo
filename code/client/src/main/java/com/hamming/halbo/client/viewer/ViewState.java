...
/**
 * ViewState is the model in the Model-View-Controller (MVC) design architecture
 * for this application. ViewState is responsible for simulating the Mycraft world.
