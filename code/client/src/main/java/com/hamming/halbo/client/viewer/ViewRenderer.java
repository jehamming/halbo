...
/**
 * ViewRenderer is responsible for managing the application's window and
 * rendering an instance of ViewState into it.
 * 
 ...
 * @since 07/12/2011
 */
final class ViewRenderer implements ViewStateListener {
    ...
    private static final String WINDOW_TITLE = "HALBO View";
    ...
    /**
     * Creates a new ViewRenderer and sets up the LWJGL window.
     * 
     * @throws LWJGLException if there is an error setting up the window
     */
    ViewRenderer() throws LWJGLException {
     ...
     * the ViewRenderer is created, before any rendering.
     */
     ...
     * Renders a ViewState.
     * 
     * @param state the ViewState to render
     */
    ...
    /**
     * Loads textures that will be used by this ViewRenderer.
     */
    ...
    /**
     * Creates the VBO that this ViewRenderer will use.
     * 
    ...
    /**
     * Updates the VBO when the a {@code chunk} in the ViewState has changed.
     * 
